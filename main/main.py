        ...
        while True:
            ...
            if self.scene == Scene.main_menu:
                ...
                for i, car in enumerate(self.cars):
                    car.tick(17)
                    if self.hitboxes: car.car_corners = [[car.pos[0]+np.cos(car.car_angle+self.CORNER_TO_CENTER_ANGLE)*self.CORNER_TO_CENTER_LEN, car.pos[1]+np.sin(car.car_angle+self.CORNER_TO_CENTER_ANGLE)*self.CORNER_TO_CENTER_LEN],
                        [car.pos[0]+np.cos(car.car_angle-self.CORNER_TO_CENTER_ANGLE)*self.CORNER_TO_CENTER_LEN, car.pos[1]+np.sin(car.car_angle-self.CORNER_TO_CENTER_ANGLE)*self.CORNER_TO_CENTER_LEN],
                        [car.pos[0]+np.cos((car.car_angle-np.pi)-self.CORNER_TO_CENTER_ANGLE)*self.CORNER_TO_CENTER_LEN, car.pos[1]+np.sin((car.car_angle-np.pi)-self.CORNER_TO_CENTER_ANGLE)*self.CORNER_TO_CENTER_LEN],
                        [car.pos[0]+np.cos((car.car_angle-np.pi)+self.CORNER_TO_CENTER_ANGLE)*self.CORNER_TO_CENTER_LEN, car.pos[1]+np.sin((car.car_angle-np.pi)+self.CORNER_TO_CENTER_ANGLE)*self.CORNER_TO_CENTER_LEN]]
                    if i > 0:
